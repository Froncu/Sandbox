...
namespace sbx
{
   Sandbox::Sandbox()
   {
      ...
      transform_b.local_scale({ 1.1, 2.7 }); // TODO: this case is wrong
      ...
      rigid_body_b.angular_velocity = -4.0;
      rigid_body_b.inverse_mass = 1.0;
      rigid_body_b.inverse_inertia = 1.0 / (0.5 * 1.0 * 8.0 * 8.0);
      ...
      rigid_body_d.inverse_mass = 1.0 / 3.0;
